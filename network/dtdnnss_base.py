...
from nas_core.activation import Activation
from nas_core.layer.common_layer.conv1d import Conv1d_
from nas_core.layer.common_layer.dtdnn import TransitLayer, DenseLayer
from nas_core.layer.common_layer.dtdnnss import DTDNNSS_
...
class DtdnnssBase(nn.Module):
    def __init__(self, num_class, mid_channels=128, feature_dim=512, loss_type='aam_loss'):
        ...
        self.loss_typ = loss_type

        # TODO Layer 1
        self.layer1 = TDNN_(in_channels=30, out_channels=128, kernel_size=5, bias=True,
                            dilation=1, in_shape=LEN_FRAME, out_shape=LEN_FRAME, act=Activation.PReLU)

        # TODO Layer 2
        self.layer2 = DTDNNSS_(in_channels=128, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 3
        self.layer3 = DTDNNSS_(in_channels=192, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 4
        self.layer4 = DTDNNSS_(in_channels=256, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 5
        self.layer5 = DTDNNSS_(in_channels=320, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 6
        self.layer6 = DTDNNSS_(in_channels=384, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 7
        self.layer7 = DTDNNSS_(in_channels=448, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)
        ...
        # TODO Layer 9
        self.layer9 = DTDNNSS_(in_channels=256, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                               dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 10
        self.layer10 = DTDNNSS_(in_channels=320, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 11
        self.layer11 = DTDNNSS_(in_channels=384, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 12
        self.layer12 = DTDNNSS_(in_channels=448, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 13
        self.layer13 = DTDNNSS_(in_channels=512, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 14
        self.layer14 = DTDNNSS_(in_channels=576, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 15
        self.layer15 = DTDNNSS_(in_channels=640, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 16
        self.layer16 = DTDNNSS_(in_channels=704, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 17
        self.layer17 = DTDNNSS_(in_channels=768, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 18
        self.layer18 = DTDNNSS_(in_channels=832, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 19
        self.layer19 = DTDNNSS_(in_channels=896, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)

        # TODO Layer 20
        self.layer20 = DTDNNSS_(in_channels=960, mid_channels=mid_channels, out_channels=64, kernel_size=3,
                                dilation=(1, 3), bias=False, in_shape=LEN_FRAME, out_shape=LEN_FRAME)
        ...
        if self.loss_type == 'aam_loss':
            ...
            self.logits = Conv1d_(feature_dim, num_class, 1, act=Activation.Identity, in_shape=1, out_shape=1)
